---------------------------------------------------
	...
	--DESCRIPCI�N: INSERCION DATOS 
	--FECHA DE CREACI�N: 17 de enero de 2021
---------------------------------------------------
--TABLA 1 
INSERT INTO PROVEEDOR(nombre, razon_social, calle, numero, colonia, estado, codigo_postal)
VALUES('Trevi�o', 'Hermanos Trevi�o S.A', 'Mesones', 22, 'Centro', 'CDMX', 00129),
...
VALUES(5568978090, 1);-- TREVI�O

INSERT INTO TELEFONO_PROVEEDOR(telefono, id_proveedor) 
VALUES(5568978091, 1);-- TREVI�O
...
VALUES('Regalos','Articulos varios para regalos y decoraci�n');--REGALOS 1

INSERT INTO CATEGORIA(nombre_categoria, descripcion_categoria)
VALUES('Papeler�a','Articulos relacionados a papeleria');--PAPELERIA 2

INSERT INTO CATEGORIA(nombre_categoria, descripcion_categoria)
VALUES('Impresiones','Servicio de impresiones en varios tama�os, c, b/n');--IMPRESIONES 3
...
VALUES ('Alma Rodriguez Martinez','ROMAA09H0', 'Paseo de duraznos', 15, 'Bosques', 'CDMX', 01520),
		('Iv�n Maldonado Aldape','ALMAI12F0', 'Ca�ada 2', 23, 'Ca�ada', 'CDMX', 01530);
...
INSERT INTO CLIENTE(nombre, razon_social, calle, numero, colonia, estado, codigo_postal)
VALUES ('Jose Zu�iga Morrison','MOZUJ78H1', 'Campeche', 12, 'Roma Norte', 'CDMX', 04098),
...
----------------------------------------------------------------------------------------------
--TABLA 8
--ALTER TABLE VENTA DROP COLUMN monto_total;-- NO EJECUTAR YA EST� CORREGIDO
